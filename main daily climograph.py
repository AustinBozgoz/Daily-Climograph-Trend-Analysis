...
date='annual' #what day to analyze the climatography for, written in the format MO-DA (so january first is 01-01), or write 'annual' to analyze every day of the year excluding february 29th
